		...
		<div className="mt-4 mx-1">
			...
			<div className="shot-stick-container">
				<svg className="absolute top-0 left-0 border-[1px] border-red-500" height="100%" width="100%">
					...
					{/* Level line */}
					<line style={{ stroke: "red", strokeWidth: 2 }} x1="20%" y1={200 - pos(num1)} x2="80%" y2={200 - pos(num1)} />
					{/* Ground tracking line */}
					<line style={{ stroke: "orange", strokeWidth: 2 }} x1="25%" y1={200} x2="80.2%" y2={100 + (pos(num2) - pos(num1) + 98)} />

					{/* Ground illustration line */}
					<line style={{ stroke: "green", strokeWidth: 2 }} x1="15%" y1={200} x2="25%" y2={200} />

					{/* Top dotted line */}
					<line style={{ stroke: "blue", strokeDasharray: "8", strokeWidth: "2" }} x1="81%" y1={100 + (pos(num2) - pos(num1) + 100)} x2="85%" y2={100 + (pos(num2) - pos(num1) + 100)} />
					{/* Bottom dotted line */}
					<line style={{ stroke: "blue", strokeDasharray: "8", strokeWidth: "2" }} x1="25%" y1={200} x2="85%" y2={200} />

					{/* Vertical connector (dotted lines) */}
					<line style={{ stroke: "blue", strokeWidth: 2 }} x1="85%" y1={100 + (pos(num2) - pos(num1) + 100)} x2="85%" y2={200} />
